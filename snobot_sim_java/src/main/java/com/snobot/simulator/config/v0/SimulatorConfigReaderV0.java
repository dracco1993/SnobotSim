...
public class SimulatorConfigReaderV0
{
    ...
    {
        try (BufferedReader br = new BufferedReader(new FileReader(aInputFile, Charset.defaultCharset())); BufferedWriter bw = new BufferedWriter(new FileWriter(aTempFile, Charset.defaultCharset())))
        {
            String line;
